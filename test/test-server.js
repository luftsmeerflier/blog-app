...
describe("Blog", function() {
  ...
  it("should add an item on POST", function() {
    const newItem = { title: "blog post", content: "Testing post for mocha/chai" };
    return chai
      .request(app)
      .post("/")
      .send(newItem)
    ...
    return (
      chai
        ...
        .then(function(res) {
          ...
          //Validating changes were actually made

          //use model to access object in question, make sure instantiated
        })
    );
  });
